...
class ContactControllerTest {
    ...
    void setup() {
        ...
        validRequest.setRequestType("Test Request");
    ...
    void handleContact_shouldReturnAccepted_whenValid() throws Exception {
        ...
        doNothing().when(mailService).sendContactMailAsync(anyString(), anyString(), anyString(), anyString(), anyString());
        ...
        verify(mailService).sendContactMailAsync(eq("Max Mustermann"), eq("max@example.com"), eq("Test Subject"),
                eq("Test Request"), eq("Test message"));
    }
