...
import {deletePost, fetchPosts} from '@/lib/api/blog';
...
export default function BlogAdminDashboard() {
    ...
    return (
        <div className="grid grid-cols-1 pt-10 pb-10 justify-center items-center px-6 mx-auto w-full max-w-7xl">
            <div className="text-6xl font-bold my-5">Blog Admin Dashboard</div>
                        ...
                        {posts.map((post) => (
                            <tr key={post.id}>
                                ...
                                <td className="p-4 border-b border-blue-gray-50 truncate overflow-hidden text-ellipsis max-w-[200px]">
                                    <ContentDialog content={post.description}/>
                                </td>
                                <td className="p-4 border-b border-blue-gray-50 truncate overflow-hidden text-ellipsis max-w-[200px]">
                                    <ContentDialog content={post.content}/>
                                </td>
                                <td className="p-4 border-b border-blue-gray-50 truncate overflow-hidden text-ellipsis max-w-[200px]">
                                    {post.cover}
                                </td>
