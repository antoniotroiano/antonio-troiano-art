...
import {deletePortfolio, fetchPortfolio} from '@/lib/api/portfolio';
...
export default function AdminDashboard() {
    ...
    return (
        <div className="grid grid-cols-1 pt-10 pb-10 justify-center items-center px-6 mx-auto w-full">
            <div className="text-6xl font-bold my-5">Portfolio Admin Dashboard</div>
                        ...
                        {portfolio.map((portfolio) => (
                            <tr key={portfolio.id}>
                                ...
                                <td className="p-4 border-b border-blue-gray-50 truncate overflow-hidden text-ellipsis max-w-[200px]">
                                    <ContentDialog content={portfolio.tags}/>
                                </td>
                                <td className="p-4 border-b border-blue-gray-50 truncate overflow-hidden text-ellipsis max-w-[200px]">
                                    <ContentDialog content={portfolio.imageUrls}/>
                                </td>
                                <td className="p-4 border-b border-blue-gray-50">
                                ...
                                <td className="p-4 border-b border-blue-gray-50">
                                    <button onClick={() => handleDelete(portfolio.id)} type="button"
                                            className="relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-gray-900 transition-all hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                                        <span
                                            className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
