            ...
            <main>
                ...
                <section id="portfolio" className="section-padding">
                    <section className="section">
                        ...
                        <div className="btn-center">
                            <a href="test/portfolio" className="btn-glass dark-text-on-light-bg">Alle Werke anzeigen</a>
                        </div>
                    </section>
                </section>
                ...
                <section id="shop" className="section-padding"
                    ...
                    <section className="section">
                        ...
                        <div className="btn-center">
                            <a href="test/shop" className="btn-glass">Zum kompletten Shop</a>
                        </div>
                    </section>
                </section>
                ...
                <section id="blog" className="section-padding">
                    <section className="section">
                        ...
                        <div className="btn-center">
                            <a href="/test/blog" className="btn-glass dark-text-on-light-bg">Alle Beiträge lesen</a>
                        </div>
                    </section>
                </section>
