                ...
                <section className="section-padding">
                    <section className="section">
                        ...
                        <div className="filter-nav">
                            <button className="active btn-chip btn-chip--on-light btn-chip--shine">Alle</button>
                            <button className="btn-chip btn-chip--on-light btn-chip--shine">Malerei</button>
                            <button className="btn-chip btn-chip--on-light btn-chip--shine">Digitale Kunst</button>
                            <button className="btn-chip btn-chip--on-light btn-chip--shine">Skulpturen</button>
                        </div>
                        {/* <div className="filter-nav">
